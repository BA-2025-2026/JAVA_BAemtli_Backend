...
4. Make a copy of `./.env.example` and call it `.env`
5. In there, choose a root password and a user password for your database
...
2. in there, choose a root password and a user password for your database
